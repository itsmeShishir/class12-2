...
# normal function run / user define function
# in build function -> print
...
# 4 types -> 
# parameter with return type -> abc
# no parameter but have return type -> abcd()
# parameter without return type -> print_Name()
# no parameter and  no return type -> functionAbc()
...
def Detail(name, age, gender):
    return f"named parameter =  my name is {name} and age is {age} and gender is {gender} from Named parameter"
