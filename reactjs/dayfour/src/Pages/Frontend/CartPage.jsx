                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <div className="p-6 border-b border-gray-200">
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-3">
                                <button className="w-8 h-8 border border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50" onClick="">
                            ...
                            <div className="text-right">
                                ...
                                <button className="text-red-600 hover:text-red-800 mt-2" onClick="">
                    ...
                    <div className="p-6">
                        <div className="flex justify-between items-center">
                            ...
                            <button className="text-red-600 hover:text-red-800 font-medium" onClick="">
