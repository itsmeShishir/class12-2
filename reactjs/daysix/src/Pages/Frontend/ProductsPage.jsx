                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden card-hover">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex items-center mb-2">
                                ...
                                <span className="text-sm text-gray-500 ml-2">(67)</span>
                            </div>
                            <div className="flex items-center justify-between mb-4">
                                <div>
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden card-hover">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex space-x-2">
                                <a href="product.html?id=5" className="flex-1 bg-blue-600 text-white py-2 px-4 rounded-lg text-center hover:bg-blue-700 transition-colors">View Details</a>
                                <button className="bg-gray-100 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-200 transition-colors">
                                    <i data-lucide="shopping-cart" className="w-4 h-4"></i>
                                </button>
                            </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden card-hover">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex items-center mb-2">
                                ...
                                <span className="text-sm text-gray-500 ml-2">(91)</span>
                            </div>
                            <div className="flex items-center justify-between mb-4">
                                <div>
                            ...
                            <div className="flex space-x-2">
                                <a href="product.html?id=6" className="flex-1 bg-blue-600 text-white py-2 px-4 rounded-lg text-center hover:bg-blue-700 transition-colors">View Details</a>
                                <button className="bg-gray-100 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-200 transition-colors">
                                    <i data-lucide="shopping-cart" className="w-4 h-4"></i>
                                </button>
                            </div>
